...
export const TILE_SYMBOL_LIBRARY = {
    ...
    N: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STONE_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_NORTH, height: 2 },
    O: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STONE_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_SOUTH, height: 2 },
    J: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STONE_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_WEST, height: 2 },
    K: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STONE_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_EAST, height: 2 },
    Q: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.TIMBER_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_NORTH, height: 2 },
    V: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.TIMBER_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_SOUTH, height: 2 },
    Y: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.TIMBER_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_WEST, height: 2 },
    Z: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.TIMBER_WINDOW_WALL, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.WINDOW_EAST, height: 2 },
    ...
    1: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STAIRS, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.STAIRS_NORTH, height: 0 },
    2: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STAIRS, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.STAIRS_SOUTH, height: 0 },
    3: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STAIRS, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.STAIRS_WEST, height: 0 },
    4: { element: ELEMENTS.STRUCTURE, texture: TEXTURE_IDS.STAIRS, effect: TILE_EFFECTS.STRUCTURE, building: BUILDING_PARTS.STAIRS_EAST, height: 0 }
};
